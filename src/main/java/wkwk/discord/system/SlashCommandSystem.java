                                                ...
                                                if (logRecord.size() > 0) {
                                                    ...
                                                    for (LoggingRecord log : logRecord) {
                                                        if (api.getServerTextChannelById(log.getTargetChannelId()).isPresent() && log.getType().equals("chat")) {
                                                            selectMenuBuilder.addOption(new SelectMenuOptionBuilder().setLabel(log.getType() + ":" + api.getServerTextChannelById(log.getTargetChannelId()).get().getName()).setValue(log.getTargetChannelId() + " " + log.getType() + " " + log.getTextChannelId()).build());
